...
--- Users ---
insert into users values ('u1', 'Maheen Lynn', '12345678');
insert into users values ('u2', 'Leena Markham', '87654321');
insert into users (uid, name) values ('u3', 'Branden Escobar');
insert into users (uid, name) values ('u4', 'Digby Tierney');
insert into users (uid, name) values ('u5', 'Harriet Beck');
insert into users (uid, name) values ('u6', 'Aron Gu');
insert into users (uid, name) values ('u7', 'Jeevan Dillard');
insert into users (uid, name) values ('u8', 'Laaibah Cano');
insert into users (uid, name) values ('u9', 'Ameila Pike');
insert into users (uid, name) values ('u10','Davood Rafiei');
insert into users (uid, name) values ('u11', 'Spencer Schimdt');
insert into users (uid, name) values ('u12', 'Ryder Catonio');
insert into users (uid, name) values ('u13', 'Dradelli Guy');
insert into users (uid, name) values ('u14', 'Aron Gu');
insert into users (uid, name) values ('u15', 'Mark Sanchez');
insert into users (uid, name) values ('u16', 'Marion Trap');
insert into users (uid, name) values ('u17', 'Mackenzie Parks');
insert into users (uid, name) values ('u18', 'Daria Blackburn');
insert into users (uid, name) values ('u19', 'Samuel Dixon');
insert into users (uid, name) values ('u20','Hamed Mirzaei');
insert into users (uid, name) values ('u21', 'Amelia Pike');
insert into users (uid, name) values ('u22', 'Quinn Mccartney');
insert into users (uid, name) values ('u23', 'Brenden Akhtar');
insert into users (uid, name) values ('u24', 'Catrina Maxwell');
insert into users (uid, name) values ('u25', 'Darsh Snyder');
insert into users (uid, name) values ('u26', 'Pheobe Shannon');
insert into users (uid, name) values ('u27', 'Judy Walsh');
insert into users (uid, name) values ('u28', 'Bret Bartlett');
insert into users (uid, name) values ('u29', 'Diogo Lowry');
insert into users (uid, name) values ('u30', 'Rudra Duke');
insert into users (uid, name) values ('u31', 'Mike Smith');
insert into users (uid, name) values ('u32', 'Conner Wang');
insert into users (uid, name) values ('u33', 'Saim Hays');
insert into users (uid, name) values ('u34', 'Jeanne Carlson');
insert into users (uid, name) values ('u35', 'John-Paul Whittaker');
insert into users (uid, name) values ('u36', 'Bjorn Partridge');
insert into users (uid, name) values ('u37', 'Dominic Chen');
insert into users (uid, name) values ('u38', 'Aleah Mendoza');
insert into users (uid, name) values ('u39', 'Kiyan Underwood');
insert into users (uid, name) values ('u40', 'Wendy Fernandez');
insert into users (uid, name) values ('u41', 'Shamima Gonzales');
insert into users (uid, name) values ('u42', 'Mike Smith');
...
--- Artists ---
insert into artists values ('u1', 'Lady Gaga', 'United States', '12345678');
insert into artists (aid, name, nationality) values ('a2', 'OneRepublic', 'United States');
insert into artists (aid, name, nationality) values ('a3', 'Imagine Dragons', 'United States');
insert into artists (aid, name, nationality) values ('a4', 'PSY', 'South Korea');
insert into artists (aid, name, nationality) values ('a5', 'P!nk', 'American');
insert into artists (aid, name, nationality) values ('a6', 'Nate Reuss', 'American');
insert into artists (aid, name, nationality) values ('a7', 'Kelly Clarkson', 'United States');
insert into artists (aid, name, nationality) values ('a8', 'Janelle Monáe', 'United States');
insert into artists (aid, name, nationality) values ('a9', 'Maroon 5', 'United States');
insert into artists (aid, name, nationality) values ('a10', 'Drake', 'Canada');
insert into artists (aid, name, nationality) values ('a11', 'Pitbull', 'American');
insert into artists (aid, name, nationality) values ('a12', 'Sia', 'Australian');
insert into artists (aid, name, nationality) values ('a13', 'Neon Trees', 'American');
insert into artists (aid, name, nationality) values ('a14', 'Carly Rae Jepsen', 'Canada');
insert into artists (aid, name, nationality) values ('a15', 'Calvin Harris', 'Scotland');
insert into artists (aid, name, nationality) values ('a16', 'Ellie Goulding', 'United Kingdom');
insert into artists (aid, name, nationality) values ('a17', 'Avicii', 'Swedish');
insert into artists (aid, name, nationality) values ('a18', 'Sean Paul', 'Jamaica');
insert into artists (aid, name, nationality) values ('a19', 'David Guetta', 'French');
insert into artists (aid, name, nationality) values ('a20', 'Bob Ezrin', 'Canadian');
insert into artists (aid, name, nationality) values ('a21', 'Echosmith', 'American');
insert into artists (aid, name, nationality) values ('a22', 'The Wanted', 'British');
insert into artists (aid, name, nationality) values ('a23', 'Selena Gomez', 'United States');
insert into artists (aid, name, nationality) values ('a24', 'Rixton', 'British');
insert into artists (aid, name, nationality) values ('a25', 'American Authors', 'American');
insert into artists (aid, name, nationality) values ('a26', 'Cobra Starship', 'American');
insert into artists (aid, name, nationality) values ('a27', 'Captial Cities', 'American');
insert into artists (aid, name, nationality) values ('a28', 'WALK THE MOON', 'United States');
insert into artists (aid, name, nationality) values ('a29', 'Jason Derulo', 'American');
insert into artists (aid, name, nationality) values ('a30', 'Taio Cruz', 'English');
insert into artists (aid, name, nationality) values ('a31', 'The Script', 'Ireland');
insert into artists (aid, name, nationality) values ('a32', 'Jennifer Lopez', 'American');
insert into artists (aid, name, nationality) values ('a33', 'Shakira', 'Colombia');
insert into artists (aid, name, nationality) values ('a34', 'The Weeknd', 'Canada');
insert into artists (aid, name, nationality) values ('a35', 'Celine Dion', 'Canada');
insert into artists (aid, name, nationality) values ('a36', 'Avril Lavigne', 'Canadian');
insert into artists (aid, name, nationality) values ('a37', 'Flo Rida', 'American');
insert into artists (aid, name, nationality) values ('a38', 'Spice Girls', 'British');
insert into artists (aid, name, nationality) values ('a39', 'Ed Sheeran', 'England');
